...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0,
    component: () => import('./_nuxt/index-8d31bd30.mjs').then((m) => m.default || m)
  }
];
...
const layouts = {
  default: /* @__PURE__ */ defineAsyncComponent(() => import('./_nuxt/default-2438d368.mjs').then((m) => m.default || m))
};
