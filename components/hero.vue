  ...
  <section class="hero desktop" id="hero-section">
    <div class="container">
      <div class="group">
        ...
        <p class="subheader2">Our mission is simple yet profound: nurture and inspire high school students from Riverside Secondary Highschool</p>
        <div class="buttons">
